...
FULL_RETURN_MAP = {
    ...
    '930839': '930839',  # 港股通高股息精选全收益
    '000015': '000015',  # 红利指数全收益
    '931848': '931848',  # 800红利低波全收益
    '980081': '980081',  # 国证价值100全收益（理杏仁 total_return）
    '932305': '932305',  # 智选高股息全收益（2024-09 发布起）
}
...
def api_market_dividend_advice():
    ...
    for code, name, cat in DIVIDEND_INDICES:
        # 250日回撤：优先全收益（理杏仁 total_return），回退价格 —— PRD §3.2
...
def api_market_dividend_detail():
    ...
    # ── 年度最大回撤（PRD §2.2 展示用，非规则；全收益口径，理杏仁 2016 起）──
    annual_dd = []
...
HK_ETFS = [
    ...
    ('512000', '券商ETF', 0.50, '证券公司指数(399975)，中证指数公司编制', '华宝'),
]
...
def api_market_full_return_compare():
    ...
    # 港股 ETF（全收益 hfq；513820 与 930914、159691 与 930839 同指数已由理杏仁 total_return 覆盖，去重）
    hk_names = {'513630': '标普港股红利低波', '159545': '恒生港股通高息低波'}
