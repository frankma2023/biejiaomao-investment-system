    ...
    .then(function(cfg) {
      ...
      var sections = {
        ...
        'n': [['n_new.high52_tiers', '52周高点阈值', '-5,-15'],
              ['n_new.high52_scores', '对应得分', '6,4'],
              ['n_new.high_lookback_days', '回溯天数', '5'],
              ['n_new.day_cap', '单日共振封顶', '10'],
              ['n_new.engine_scores.base_breakout_v2', '基部突破V2分', '7'],
              ['n_new.engine_scores.pocket_pivot_v2', '口袋支点V2分', '7'],
              ['n_new.engine_scores.pocket_pivot', '口袋支点V1分', '5'],
              ['n_new.engine_scores.box_breakout', '箱体突破分', '3'],
              ['n_new.engine_scores.base_breakout', '基部突破V1分', '3'],
              ['n_new.engine_scores.double_bottom', '双重底分', '2'],
              ['n_new.engine_scores.cup_handle', '杯柄分', '2'],
              ['n_new.engine_scores.flat_base', '扁平基部/碟形分', '2'],
              ['n_new.engine_scores.cdl_bullish', 'K线形态分', '2'],
              ['n_new.engine_scores.talib_bullish', 'TA指标分', '1'],
              ['n_new.mw_quality.tiers', 'MW质量分档(≥)', '85,70,55'],
              ['n_new.mw_quality.scores', 'MW对应得分', '6,5,3,2']],
